                        ...
                        <HorizontalGroup className="pathActions">
                            <ActionIconButtonStyled id="pathUnion">
                                <svg width="23px" height="23px" viewBox="0 0 23 23">
                                    <path fill="#FF386B" fill-rule="evenodd" stroke="#000" d="M58.2380952,49 L62.6984127,49 C64.1009524,49 65.2380952,50.1371429 65.2380952,51.5396825 L65.2380952,61.6984127 C65.2380952,63.1009524 64.1009524,64.2380952 62.6984127,64.2380952 L52.5396825,64.2380952 C51.1371429,64.2380952 50,63.1009524 50,61.6984127 L50,58.2380952 L45.5396825,58.2380952 C44.1371429,58.2380952 43,57.1009524 43,55.6984127 L43,45.5396825 C43,44.1371429 44.1371429,43 45.5396825,43 L55.6984127,43 C57.1009524,43 58.2380952,44.1371429 58.2380952,45.5396825 L58.2380952,49 Z" transform="translate(-42 -42)"/>
                                </svg>
                            ...
                            <ActionIconButtonStyled id="pathSubtract">
                                <svg width="22px" height="22px" viewBox="0 0 22 22">
                                    <g fill="none" fill-rule="evenodd">
                                        <path fill="#FF386B" d="M9.5,6 C8.119375,6 7,7.119375 7,8.5 L7,18.5 C7,19.880625 8.119375,21 9.5,21 L19.5,21 C20.880625,21 22,19.880625 22,18.5 L22,8.5 C22,7.119375 20.880625,6 19.5,6 L9.5,6 Z"/>
                                        <path fill="#FF386B" d="M2.5,0 C1.119375,0 0,1.119375 0,2.5 L0,12.5 C0,13.880625 1.119375,15 2.5,15 L12.5,15 C13.880625,15 15,13.880625 15,12.5 L15,2.5 C15,1.119375 13.880625,0 12.5,0 L2.5,0 Z"/>
                                        ...
                                        <path fill="#FFF" d="M8.97909587,6.07689333 L15.032683,6.07689333 L15.032683,14.0700808 C15.032683,14.6223655 14.5849678,15.0700808 14.032683,15.0700808 L6.97909587,15.0700808 L6.97909587,8.07689333 C6.97909587,6.97232383 7.87452637,6.07689333 8.97909587,6.07689333 Z"/>
                                    </g>
                                </svg>
                            </ActionIconButtonStyled>
                            <ActionIconButtonStyled id="pathDifference">
                                <svg width="23px" height="23px" viewBox="0 0 23 23">
                                    <g fill="none" fill-rule="evenodd" transform="translate(1 1)">
                                        <path fill="#FF386B" stroke="#000" d="M2.53968254,0 C1.13714286,0 0,1.13714286 0,2.53968254 L0,12.6984127 C0,14.1009524 1.13714286,15.2380952 2.53968254,15.2380952 L12.6984127,15.2380952 C14.1009524,15.2380952 15.2380952,14.1009524 15.2380952,12.6984127 L15.2380952,2.53968254 C15.2380952,1.13714286 14.1009524,0 12.6984127,0 L2.53968254,0 Z"/>
                                        <path fill="#FFF" d="M9.53968254,6 C8.13714286,6 7,7.13714286 7,8.53968254 L7,18.6984127 C7,20.1009524 8.13714286,21.2380952 9.53968254,21.2380952 L19.6984127,21.2380952 C21.1009524,21.2380952 22.2380952,20.1009524 22.2380952,18.6984127 L22.2380952,8.53968254 C22.2380952,7.13714286 21.1009524,6 19.6984127,6 L9.53968254,6 Z"/>
                                    </g>
                                </svg>
                            </ActionIconButtonStyled>
                        </HorizontalGroup>
