...
export default class ActionHeader extends ComponentWithImmutableState<IActionHeaderProps, IActionHeaderState> {
    ...
    render() {
        ...
        if (this.state.data.activeMode === "prototype") {
            ...
            return <ActionHeaderComponent className="action_header">
                <ActionGroup className="left">
                    <Tools key="tools"></Tools>
                </ActionGroup>
                <ActionGroup>
                ...
                <ActionGroup className="right">
                    <RepeatDropButton />
                    <VerticalSeparator/>
                    <FlyoutButton
                        position={{ targetVertical: "bottom", targetHorizontal: "center" }}
                        renderContent={() =>
                            <IconButton icon={icons.symbols_small} width={46} height={46} title="@symbol.menu" label="@symbol.menu"/>
                        }>
                        <FlyoutBody>
                    ...
                    <FlyoutButton
                        position={{ targetVertical: "bottom", targetHorizontal: "center" }}
                        renderContent={() =>
                            <IconButton icon={icons.m_arrange} width={46} height={46} title="@arrange.menu" label="@arrange.menu" />
                        }>
                        <FlyoutBody>
                    ...
                    <FlyoutButton
                        position={{ targetVertical: "bottom", targetHorizontal: "center" }}
                        renderContent={() =>
                            <IconButton icon={icons.m_pathop} width={46} height={46} title="@path.menu" label="@path.menu"/>
                        }>
                        <FlyoutBody>
                    ...
                    <FlyoutButton
                        position={{ targetVertical: "bottom", targetHorizontal: "center" }}
                        renderContent={() =>
                            <IconButton icon={icons.m_group} width={46} height={46} title="@group.menu" label="@group.menu" />
                        }>
                        <FlyoutBody>
