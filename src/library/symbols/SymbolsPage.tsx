...
export default class SymbolsPage extends Component<any, any> {
    ...
    render() {
        return  <Symbols ref="tab1" />;
        // <TabContainer id="stencils-page" className="gui-page__content" currentTabId={this.state.tabId} onTabChanged={tabId => dispatchAction({ type: "Library_Tab", area: "stencils", tabId })}>
        //     <TabTabs
        //         items={[
